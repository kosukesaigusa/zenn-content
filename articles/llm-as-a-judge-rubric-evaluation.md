...
topics: ["LLM", "LLMOps", "AI", "aiエンジニアリング"]
published: true
...
Ubie では、LLM を活用したプロダクトの開発・運用を行っています。医療・健康というドメインの特性上、正確性や安全性には高い水準が求められます。また、"Helpfulness"（有用性）や "Empathy"（共感性）といった定性的な価値も同時に担保する必要があります。
